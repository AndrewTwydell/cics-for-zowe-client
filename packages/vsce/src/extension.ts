...
// import CICSTree from "./utils/V2/CICSTree";
// import CICSTree from "./utils/V2/V3";
import { CICSTree } from "./utils/V5/fix";
...
export async function activate(context: ExtensionContext) {
    ...
    if (ProfileManagement.apiDoesExist()) {
        try {
            ...
            const apiRegister = ProfileManagement.getExplorerApis();
